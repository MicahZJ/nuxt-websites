<template>
  <div id="example-wrapper">
    <nav-bar />
    <banner title="工程案例" :image-s="bannerImg" />
    <div v-loading="loading" class="example-section">
      <div class="example-section-content">
        <div
          v-for="(item, index) in caseList"
          :key="index"
          class="example-section-content-list"
        >
          <el-image
            :src="item.Img"
            lazy
          ...
          >
            <p class="abstract-title">{{ item.Title }}</p>
            <p class="abstract-content">{{ item.Content }}</p>
...
export default {
  ...
  data() {
    return {
      loading: false,
      bannerImg: require("../../assets/images/bg_project.jpg"),
      caseList: [
        {
          Content:
          ...
          CreateTime: "2018-09-29T19:04:52.56",
          Id: 21,
          Img: require("../../assets/images/6-1.jpg"),
          Title: "News！",
          Type: 1
        },
        {
